...
ActiveRecord::Schema[7.1].define(version: 2024_01_12_221033) do
  ...
  create_table "search_analytics", force: :cascade do |t|
    ...
    t.index ["article_id"], name: "index_search_analytics_on_article_id"
  ...
  add_foreign_key "search_analytics", "articles"
